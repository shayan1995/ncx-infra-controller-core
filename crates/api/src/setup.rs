...
use nico_dpa_interface_controller::DpaInfo;
use nico_dpa_interface_controller::context::DpaInterfaceStateHandlerServices;
use nico_dpa_interface_controller::handler::DpaInterfaceStateHandler;
use nico_dpa_interface_controller::io::DpaInterfaceStateControllerIO;
...
use nico_machine_controller::dpf::{
    NicoBmcPasswordProvider, NicoDPFLabeler, DpfOperations, DpfSdkOps,
};
...
pub async fn start_api(
    ...
    let dpf_sdk: Option<Arc<dyn DpfOperations>> = if nico_config.dpf.enabled {
        ...
        let provider = NicoBmcPasswordProvider::new(credential_manager.clone());
        ...
        let sdk = nico_dpf::DpfSdkBuilder::new(repo, nico_dpf::NAMESPACE, provider)
            .with_labeler(NicoDPFLabeler::new(
        ...
        switch_system_image_rms_client: nico_config
            ...
            .map(|url| {
                ...
                Arc::new(librms::RackManagerApi::new(&rms_api_config))
                    as Arc<dyn nico_rack::rms_client::SwitchSystemImageRmsClient>
            }),
