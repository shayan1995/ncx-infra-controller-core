...
async fn test_insert_list_remove_rack_override(
    ...
    env.api
        .insert_rack_health_report(Request::new(rpc_nico::InsertRackHealthReportRequest {
    ...
    let list_resp = env
        .api
        .list_rack_health_reports(Request::new(rpc_nico::ListRackHealthReportsRequest {
            rack_id: Some(rack_id.clone()),
        }))
        .await?
        .into_inner();
    ...
    env.api
        .remove_rack_health_report(Request::new(rpc_nico::RemoveRackHealthReportRequest {
            rack_id: Some(rack_id.clone()),
...
async fn test_rack_health_visible_in_find_racks_by_ids(
    ...
    let rack_resp = env
        .api
        .find_racks_by_ids(Request::new(rpc_nico::RacksByIdsRequest {
...
async fn test_rack_health_aggregation(
    ...
    let mut override_metrics = env
        .test_meter
        .formatted_metrics("nico_racks_health_overrides_count");
    ...
    let mut status_metrics = env
        .test_meter
        .formatted_metrics("nico_racks_health_status_count");
    status_metrics.sort();
    assert_eq!(
        status_metrics,
        vec![
