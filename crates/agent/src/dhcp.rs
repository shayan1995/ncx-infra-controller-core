...
use ::rpc::nico as rpc;
use nico_rpc_utils::dhcp::HostConfig;
...
pub const SERVER_PATH: &str = "etc/supervisor/conf.d/default-nico-dhcp-server.conf";
pub const SERVER_CONFIG_PATH: &str = "var/support/nico-dhcp/conf/dhcp.yaml";
pub const SERVER_HOST_CONFIG_PATH: &str = "var/support/nico-dhcp/conf/host.yaml";

pub const TMPL_EMPTY: &str = "# Auto-generated by NICo!";
const TMPL_SERVER: &str = include_str!("../templates/default-nico-dhcp-server.conf");

pub const RELOAD_CMD: &str = "supervisorctl update";
// Since we don't update default-nico-dhcp-server.conf file, supervisord does not restart it on
// `supervisorctl update` command.
pub const RELOAD_DHCP_SERVER: &str =
    "supervisorctl update;supervisorctl restart nico-dhcp-server-default";

pub const STOP_DHCP_SERVER: &str =
    "supervisorctl update;supervisorctl stop nico-dhcp-server-default";

/// Generate default-nico-dhcp-server.conf
